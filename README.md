...
| -------------------------- | -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Mahmoud&nbsp;Mostafa**   | Project Setup & Core Finance Features              | • Set up the Angular project folder structure <br> <br>• Managed task assignment and development workflow coordination<br> <br>• Implemented Categories feature UI and business flow<br> <br>• Built Transactions feature with CRUD operations and filtering support<br> <br>• Developed Budgets feature and finance workflow integration<br> <br>• Applied Angular Signals and computed state management across finance modules |
| **Marwa&nbsp;Ashraf**      | Core Frontend Infrastructure & Authentication Flow | • Configured environment setup and API integration structure<br> <br>• Built thin API service abstraction layer<br> <br>• Implemented authentication service using Angular Signals<br> <br>• Developed auth guards and HTTP interceptor flow<br> <br>• Configured feature-based routing structure<br> <br>• Implemented login and registration frontend flows                                                                    |
| **Mohamed&nbsp;Wael**      | Shared UI System & Layout Architecture             | • Built reusable UI component system (Button, Input, Modal, Table, Toast, etc.)<br> <br>• Developed responsive Navbar and Sidebar layouts<br> <br>• Implemented main application layout structure<br> <br>• Created reusable chart components and utility pipes<br> <br>• Standardized loading, empty, and error UI states across the application                                                                                |
| **Abdulrahman&nbsp;Nagah** | Dashboard & Reporting Experience                   | • Developed dashboard UI and summary visualization flows<br> <br>• Integrated analytics and reusable chart components<br> <br>• Built reports feature interface and advanced filtering UI<br> <br>• Connected dashboard data presentation with finance modules                                                                                                                                                                   |
| **Mohanad&nbsp;Tarek**     | Advanced Features & Premium Experience             | • Implemented notifications interface and unread notification flows<br> <br>• Developed chatbot frontend experience and interaction flow<br> <br>• Built payments and pricing UI flows<br> <br>• Implemented subscription and premium feature gating interfaces<br> <br>• Developed profile management frontend screens and interactions                                                                                         |### Collaboration model
